...
def test_replay():
    ...
    with dbing.openDB(name="deb") as debDB, keeping.openKS(name="deb") as debKS, \
        ...
        assert debCamVrcs == (b'{"v":"KERI10JSON000105_","i":"EiRjCnZfca8gUZqecerjGpjkiY8dIkGudP'
        ...
        assert debBevVrcs == (b'{"v":"KERI10JSON000105_","i":"BaYh8uaASuDjMUd8_BoNyQs3GwupzmJL8_'
