...
# TODO:  Fix tests when delegating is updated to support new Habery
# def test_delegating():
#     # Dan is the delegator
#     # Deb is the delegatee, or the entity "requesting" delegation of an identifier
#     with habbing.openHab(name="dan", salt=b'0123456789abcdef', transferable=True, temp=True) as (danHby, danHab):
#         # delegatee
