...
def test_habery():
    ...
    assert len(bran) == 22
    # these are the ones generated by Manager for given bran
    seed4bran = 'AP9sVywnv0Kt-XPEokBPWEngkF-8lEiD4fFQwhgc6qKY'
    aeid4seed = 'BHIbuUDuZVOmmWGDpKrALXg3T2SokMoAW37tGh4tXuem'
