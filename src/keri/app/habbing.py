...
class Habery:
    ...
    Attributes:
        ...
        cf (Configer): Config file instance.
        mgr (Manager | None): Key manager for creating and rotating keys.
...
class BaseHab:
    ...
    def __init__(self, ks, db, cf, mgr, rtr, rvy, kvy, psr, *,
        ...
        Parameters:
            ...
            pre (str | None): qb64 identifier prefix of own local controller,
                else None.
    ...
    def rotate(self, *, verfers=None, digers=None, isith=None, nsith=None, toad=None, cuts=None, adds=None,
        ...
        Parameters:
            ...
            digers (list | None): Diger instances of public next key digests
                qb64.
            isith (int | str | None): current signing threshold as int, str
                hex, or list of str weights. Default is prior next sith.
            nsith (int | str | None): next signing threshold as int, str hex,
                or list of str weights. Default is based on isith when None.
            toad (int | str | None): hex of witness threshold after cuts and
                adds.
            cuts (list | None): qb64 prefixes of witnesses to be removed from
                the witness list.
            adds (list | None): qb64 prefixes of witnesses to be added to the
                witness list.
            data (list | None): dicts of committed data such as seals.
    ...
    def decrypt(self, ser, verfers=None, **kwa):
        ...
        Parameters:
            ser (str | bytes | bytearray | memoryview): serialization to
                decrypt.
            verfers (list[Verfer] | None): Verfer instances to get public
    ...
    def query(self, pre, src, query=None, **kwa):
        ...
        Parameters:
            ...
            query (dict | None): additional query modifiers to include in
                ``q``.
    ...
    def exchange(self, route,
        ...
        Parameters:
            ...
            date (str | None): date-time-stamp string. None means use now.
            eid (str | None): qb64 of endpoint provider identifier if any.
            dig (str | None): qb64 digest if any.
            modifiers (dict | None): additional modifiers for the exchange.
            embeds (dict | None): embedded message serders if any.
    ...
    def replay(self, pre=None, fn=0):
        ...
        Parameters:
            pre (str | None): qb64 str or bytes of identifier prefix.
                Default is own ``.pre``.
    ...
    def fetchRoleUrls(self, cid: str, *, role: str = "", scheme: str = "",
        ...
        Parameters:
            ...
            scheme (str): url scheme filter. Empty string means all schemes.
            eids (list | None): when provided, restrict results to only eids
                in this list.
    ...
    def makeEndRole(self, eid, role=Roles.controller, allow=True, stamp=None):
        ...
        Parameters:
            ...
            stamp (str | None): date-time-stamp RFC-3339 profile of iso8601
    ...
    def makeLocScheme(self, url, eid=None, scheme="http", stamp=None):
        ...
        Parameters:
            ...
            eid (str | None): qb64 of endpoint provider to be authorized.
    ...
    def loadLocScheme(self, eid, scheme=None):
        ...
        Parameters:
            eid (str): qb64 identifier prefix of endpoint provider.
            scheme (str | None): url scheme filter. None means all schemes.
    ...
    def replyEndRole(self, cid, role=None, eids=None, scheme=""):
        ...
        Parameters:
            ...
            role (str | None): endpoint role filter. None means all roles.
            eids (list | None): when provided, restrict results to only eids
                in this list.
            scheme (str): url scheme filter. Empty string means all schemes.
...
class Hab(BaseHab):
    ...
    def make(self, *, secrecies=None, iridx=0, code=MtrDex.Blake3_256, dcode=MtrDex.Blake3_256,
        ...
        Parameters:
            secrecies (list | None): List of secret seeds to pre-load key
            ...
            isith (int | str | list | None): Incepting signing threshold as an
                int, hex str, or weighted list. Computed from ``verfers`` when
                ``None``.
            icount (int): Number of incepting signing keys. Defaults to ``1``.
            nsith (int | str | list | None): Next signing threshold as an int,
                hex str, or weighted list. Defaults to ``isith`` when ``None``.
            ncount (int | None): Number of next (pre-rotated) keys. Defaults
                to ``icount`` when ``None``.
            toad (int | str | None): Witness threshold as an int or hex str.
                Computed from the number of witnesses when ``None``.
            wits (list | None): qb64 prefixes of witnesses, if any.
            delpre (str | None): qb64 delegator identifier prefix, if any.
            ...
            hidden (bool): When ``True`` the Hab is not saved to the habitat
                ...
                Defaults to ``False``.
            data (list | None): Seal dicts to embed in the inception event.
            algo (str | None): Key-creation algorithm code used by the key
                manager when generating new keys.
            salt (str | None): qb64 salt for randomisation when the salty
                algorithm is used.
            tier (str | None): Security-criticality tier code used with the
                salty algorithm.
    ...
    def rotate(self, *, isith=None, nsith=None, ncount=None, toad=None, cuts=None, adds=None,
        ...
        Parameters:
            isith (int | str | list | None): Current signing threshold as an
            ...
            toad (int | str | None): Witness threshold after cuts and adds, as
                an int or hex str.
            cuts (list | None): qb64 prefixes of witnesses to remove.
            adds (list | None): qb64 prefixes of witnesses to add.
            data (list | None): Seal dicts to embed in the rotation event.
...
class SignifyHab(BaseHab):
    ...
    def sign(self, ser, verfers=None, indexed=True, indices=None, ondices=None, **kwa):
        ...
        Parameters:
            ser (bytes): Serialization to sign.
            verfers (list | None): Ignored.
            indexed (bool): Ignored.
            indices (list | None): Ignored.
            ondices (list | None): Ignored.
            **kwa: Ignored.
    ...
    def exchange(self, serder, seal=None, sigers=None, save=False):
        ...
        Parameters:
            ...
            seal (Seal | None): Optional seal to attach to the message.
            sigers (list | None): Siger instances carrying signatures
                over ``serder.raw``.
    ...
    def replyEndRole(self, cid, role=None, eids=None, scheme=""):
        ...
        * ``cid`` + ``role`` + ``scheme`` — end authz for all eids in
        ...
        Parameters:
            ...
            role (str | None): Authorised role to filter by. ``None`` means
                all roles.
            eids (list | None): When provided, restricts returned records to
...
class SignifyGroupHab(SignifyHab):
    ...
    def rotate(self, *, smids=None, rmids=None, serder=None, sigers=None, **kwargs):
        ...
        Parameters:
            smids (list | None): Updated qb64 prefixes of signing members
                after rotation.
            rmids (list | None): Updated qb64 prefixes of rotating members
                after rotation.
            serder (SerderKERI): Pre-built rotation event serder.
            sigers (list[Siger]): Siger instances carrying the remote
                agent's signatures over ``serder.raw``.
...
class GroupHab(BaseHab):
    ...
    Attributes:
        ...
        name (str): Alias of the controller.
        pre (str): qb64 prefix of the own local controller, or ``None`` if new.
        mhab (Hab | None): Local participant member hab of this group hab.
        smids (list | None): qb64 prefixes of current signing members of
            the group.
        rmids (list | None): qb64 prefixes of rotating members of the
    ...
    def __init__(self, smids, mhab=None, rmids=None, **kwa):
        ...
        Parameters:
            smids (list[str]): qb64 prefixes of the current signing members of
                the multisig group.
            mhab (Hab | None): Local participant member hab. The ``mhab.pre``
                aid may appear in ``smids``, ``rmids``, or both.
            rmids (list | None): qb64 prefixes of the rotating members of
    ...
    def make(self, *, code=MtrDex.Blake3_256, transferable=True, isith=None, nsith=None,
        ...
        Parameters:
            ...
            merfers (list[Verfer]): ``Verfer`` instances of the public signing
                ...
                by convention.
            migers (list | None): ``Diger`` instances of the public
    ...
    def rotate(self, smids=None, rmids=None, serder=None, **kwargs):
        ...
        Parameters:
            ...
            rmids (list | None): Updated qb64 prefixes of rotating members
                after rotation.
            serder (SerderKERI | None): Pre-built rotation event serder.  When
    ...
    def sign(self, ser, verfers=None, indexed=True, rotated=False, indices=None, ondices=None):
        ...
        Parameters:
            ...
            verfers (list | None): ``Verfer`` instances representing
            ...
            rotated (bool): When ``True``, compute dual-indexed signatures —
                ...
                is set to ``None``.
            indices (list | None): Explicit current signing indices.
                Passed through to ``Manager.sign``; computed automatically
                when ``None``.
            ondices (list | None): Explicit prior-next other
    ...
    def query(self, pre, src, query=None, **kwa):
        ...
        Parameters:
            ...
            query (dict | None): Additional query modifiers to include in the
