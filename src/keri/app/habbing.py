...
def openHby(*, name="test", base="", temp=True, salt=None, **kwa):
    ...
    Parameters:
        ...
        temp (bool): True means use temporary or limited resources testing.
            ...
            for seeds such as bran salt to seed or key creation of Habs.
...
class Habery:
    ...
    def __init__(self, *, name='test', base="", temp=False,
        ...
        Parameters:
            ...
            base (str): optional directory path segment inserted before name
                ...
                optional.
            temp (bool): True means use temporary or limited resources testing.
                Store .ks, .db, and .cf in /tmp. Use quick method to stretch
                salts for seeds such as bran salt to seed or key creation of Habs.
                Otherwise use more resources set by tier to stretch.
            ks (Keeper):  keystore lmdb subclass instance
            db (Baser): database lmdb subclass instance
            cf (Configer): config file instance
            clear (bool): True means remove resource directory upon close when
                reopening, False means do not remove directory upon close.
    ...
    def setup(self, *, seed=None, aeid=None, bran=None, pidx=None, algo=None,
        ...
        Parameters:
            ...
            temp (bool): True means use shortcuts for testing.
                Use quick method to stretch salts for seeds such as bran salt
                to seed or key creation of Habs.
                Otherwise use more resources set by tier to stretch.
        """
    ...
    def makeHab(self, name, ns=None, cf=None, **kwa):
        ...
        Parameters:
            ...
            estOnly (str): TraitDex.EstOnly means only establishment events
                allowed in KEL for this Hab
    ...
    def joinGroupHab(self, pre, group, mhab, smids, rmids=None, ns=None):
        ...
        Parameters:
            ...
            rmids (list | None): group member rotation ids (qb64) from which to extract
                inception event next key digests. If None, use smids. If empty,
                no next key digests (group identifier becomes non-transferable).
    ...
    def reconfigure(self):
        ...
        Config file format (json or hjon)::
...
class HaberyDoer(doing.Doer):
    ...
    Inherited Attributes:
        .done is Boolean completion state: True means completed,
...
class BaseHab:
    ...
    Attributes:
        ...
        temp (bool): True means testing: use weak level when salty algo for
            stretching in key creation for incept and rotate of keys for this hab.pre
        inited (bool): True means fully initialized wrt databases,
            False means not yet fully initialized.
    ...
    Properties:
        ...
        prefixes (OrderedSet): local prefixes for .db
        accepted (bool): True means accepted into local KEL, False otherwise.
    ...
    def rotate(self, *, verfers=None, digers=None, isith=None, nsith=None, toad=None, cuts=None, adds=None,
        ...
        Parameters:
            ...
            isith (int | str | None): current signing threshold as int, str hex,
                or list of str weights. Default is prior next sith.
            nsith (int | str | None): next, next signing threshold as int, str hex,
