...
def loadEnds(app, *,
    ...
    resources = [identifierEnd, registryEnd, oobiEnd, credsEnd, keyEnd, signalEnd,
                 presentationEnd, chacha, contact, escrowEnd, lockEnd, aeidEnd]

    app.add_route("/spec.yaml", specing.SpecResource(app=app, title='KERI Interactive Web Interface API',
                                                     resources=resources))
    return [identifierEnd, registryEnd, oobiEnd, credsEnd, presentationEnd, lockEnd, chacha]
