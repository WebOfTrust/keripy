...
def vlei(args):
    ...
    doers = booting.setup(servery=rootGAR1, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
    ...
    doers += booting.setup(servery=rootGAR2, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-root-oobis-schema",
    ...
    doers += booting.setup(servery=extGAR1, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
    ...
    doers += booting.setup(servery=extGAR2, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-gar-oobis-schema",
    ...
    doers += booting.setup(servery=intGAR1, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-gar-oobis-schema",
                           configDir="./scripts", insecure=True, tcp=5724, adminHttpPort=5624,
                           path=start.STATIC_DIR_PATH)
    # IntGAR2
    intGAR2 = booting.Servery(port=5625)
    doers += booting.setup(servery=intGAR2, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-gar-oobis-schema",
    ...
    doers += booting.setup(servery=qar1, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
    ...
    doers += booting.setup(servery=qar2, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-qar-oobis-schema",
    ...
    doers += booting.setup(servery=lar1, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-qar-oobis-schema",
                           configDir="./scripts", insecure=True, tcp=5728, adminHttpPort=5628,
                           path=start.STATIC_DIR_PATH)
    # LAR2
    lar2 = booting.Servery(port=5629)
    doers += booting.setup(servery=lar2, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-qar-oobis-schema",
    ...
    doers += booting.setup(servery=person, controller="E59KmDbpjK0tRf9Rmc7OlueZVz7LB94DdD3cjQVvPcng",
                           configFile="vlei-qar-oobis-schema",
                           configDir="./scripts", insecure=True, tcp=5730, adminHttpPort=5630,
                           path=start.STATIC_DIR_PATH)

    return doers + [rootGAR1, rootGAR2, extGAR1, extGAR2, intGAR1, intGAR2, qar1, qar2, lar1, lar2, person]
