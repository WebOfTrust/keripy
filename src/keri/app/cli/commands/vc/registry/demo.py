...
def demo(args):
    ...
    ms2 = incept.RegistryInceptor(name="multisig2", registryName="gleif2", estOnly=False, noBackers=True, baks=[])
    ms3 = incept.RegistryInceptor(name="multisig3", registryName="gleif3", estOnly=False, noBackers=True, baks=[])
