...
def registryIncept(args):
    ...
    icpDoer = RegistryInceptor(name=name, base=base, config_dir=config_dir, alias=alias, bran=bran, registryName=registryName,
...
class RegistryInceptor(doing.DoDoer):
    ...
    def __init__(self, name, base, config_dir, alias, bran, registryName, **kwa):
        ...
        Parameters:
            ...
            config_dir  (str): optional root path of all configuration and database files
