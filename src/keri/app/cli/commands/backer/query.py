...
Backer Query Ledger command line interface
"""
import argparse
import logging
...
d = "Query KEL on ledger for a given prefix\n"
...
parser.add_argument('--prefix', '-pre', help='Prefix to query',
                    required=True, default=None)
...
def launch(args):
    ...
    if args.ledger == "cardano":
        cardaning.queryBlockchain(args.prefix, hab,ks)
