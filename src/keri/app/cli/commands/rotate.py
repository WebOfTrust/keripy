...
def rotate(args):
    ...
    """
    opts = merge_args_with_file(args)
...
def merge_args_with_file(args):
    ...
    """
    rotate_opts = config.load_file_options(args.file, RotateOptions) if args.file != '' else empty_options()
    ...
    if args.data is not None:
        rotate_opts.data = config.parse_data(args.data)
