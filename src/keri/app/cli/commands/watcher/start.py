...
from keri.app import directing, indirecting, watching, habbing, storing, configing
...
def startWatcher(args):
    ...
    doers = setupWatcher(name, controller=args.controller, alias=args.alias, base=args.base, config_dir=args.config_dir,
                         bran=args.bran, tcpPort=tcpPort, httpPort=httpPort)
    return doers


def setupWatcher(name="watcher", controller=None, alias="watcher", base="", config_dir=None, bran=None,
                 tcpPort=5651, httpPort=5652):
    """
    """
    cf = None
    ...
    hby = habbing.Habery(name=name, base=base, cf=cf, bran=bran, headDirPath=config_dir)
