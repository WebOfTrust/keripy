...
def regcept(issuer, *, uuid=None, stamp=None,
    ...
    Parameters:
        ...
        uuid (str|None): qb64 of salty nonce (UUID) if any. None means no UUID
...
def actacdc(issuer, nonce=None, registry=None, schema=None,
          issuee=None, attributes=None, edges=None, rules=None,
            pvrsn=Vrsn_2_0, gvrsn=Vrsn_2_0, kind=Kinds.json):
...
def acmacdc(issuer, schema, ilk=None, issuee=None, nonce=None, registry=None,
