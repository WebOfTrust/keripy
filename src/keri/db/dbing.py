...
@contextmanager
def openDatabaser(cls=None, name="test", temp=True, opened=True, **kwa):
    """
    Context manager wrapper Databaser instances.
    Defaults to temporary databases.
    Context 'with' statements call .close on exit of 'with' block

    Parameters:
        cls is Class instance of subclass instance
        name is str name of Databaser dirPath so can have multiple databasers
