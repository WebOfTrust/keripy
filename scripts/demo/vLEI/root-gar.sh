...
curl -s -X POST "http://localhost:5620/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"rootgar2\", \"url\":\"http://127.0.0.1:5642/oobi/EUwocCDxDjqV0gT1ah6dA1FWDyR4EQyHEayQzeS0h-PA/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
curl -s -X POST "http://localhost:5621/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"rootgar1\", \"url\":\"http://127.0.0.1:5642/oobi/EC_y9UOQlOD8LEQDx3rnrJdwo3LVOzA6VdCK67qT2C-g/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
sleep 3
#
