...
kli challenge respond --name extgar1 --alias extgar1 --recipient "GLEIF ROOT" --words "fortune border random swear shine flame fury weasel rebuild coconut together pistol"
kli challenge respond --name extgar2 --alias extgar2 --recipient "GLEIF ROOT" --words "fortune border random swear shine flame fury weasel rebuild coconut together pistol"
