...
# kli vc registry incept --name multisig1 --alias multisig --registry-name multisig-registry
# kli vc registry incept --name multisig2 --alias multisig --registry-name multisig-registry
