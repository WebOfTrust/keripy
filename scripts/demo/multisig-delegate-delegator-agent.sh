...
sleep 2
curl -s -X POST "http://localhost:5623/oobi/delegator" -H "accept: */*" -H "Content-Type: application/json" -d "{\"url\":\"http://127.0.0.1:5642/oobi/EZbh5QuW1HI4dmYZrKYIjXE_34E5c2np8HjKggen7bu8/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
curl -s -X POST "http://localhost:5723/oobi/delegator" -H "accept: */*" -H "Content-Type: application/json" -d "{\"url\":\"http://127.0.0.1:5642/oobi/EZbh5QuW1HI4dmYZrKYIjXE_34E5c2np8HjKggen7bu8/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
