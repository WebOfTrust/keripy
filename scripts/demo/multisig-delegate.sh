...
kli oobi resolve --name multisig1 --oobi http://127.0.0.1:5642/oobi/E8AKUcbZyik8EdkOwXgnyAxO5mSIPJWGZ_o7zMhnNnjo/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo
kli oobi resolve --name multisig2 --oobi http://127.0.0.1:5642/oobi/E8AKUcbZyik8EdkOwXgnyAxO5mSIPJWGZ_o7zMhnNnjo/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo

# kli multisig incept --name multisig1 --alias multisig1 --group multisig --file tests/app/cli/commands/multisig/multisig-delegate-sample.json
# kli multisig incept --name multisig2 --alias multisig2 --group multisig --file tests/app/cli/commands/multisig/multisig-delegate-sample.json
