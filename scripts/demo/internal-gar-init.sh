...
# kli multisig incept --name intgar1 --alias intgar1 --group "External GAR" --file scripts/demo/external-gar-incept.json
# kli multisig incept --name intgar2 --alias intgar2 --group "External GAR" --file scripts/demo/external-gar-incept.json
