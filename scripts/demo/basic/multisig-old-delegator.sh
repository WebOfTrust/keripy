...
kli_1 oobi resolve --name "$delegator_1" --oobi "$delegator_2_oobi"
kli_1 oobi resolve --name "$delegator_2" --oobi "$delegator_1_oobi"
...
kli_2 init --name "$delegate_1" --nopasscode
kli_2 init --name "$delegate_2" --nopasscode

kli_2 oobi resolve --name "$delegate_1" --oobi "$delegate_witness_url"
kli_2 oobi resolve --name "$delegate_2" --oobi "$delegate_witness_url"
...
# kli_1 oobi resolve --name "$delegator_1" --oobi "$delegate_1_oobi"
# kli_1 oobi resolve --name "$delegator_2" --oobi "$delegate_2_oobi"
kli_2 oobi resolve --name "$delegate_1" --oobi "$delegator_oobi"
kli_2 oobi resolve --name "$delegate_2" --oobi "$delegator_oobi"
kli_2 oobi resolve --name "$delegate_1" --oobi "$delegate_2_oobi"
kli_2 oobi resolve --name "$delegate_2" --oobi "$delegate_1_oobi"
...
kli_2 multisig incept --name "$delegate_1" --alias member --group delegate --file "$delegate_json" &
PID_LIST="$!"
kli_2 multisig incept --name "$delegate_2" --alias member --group delegate --file "$delegate_json" &
PID_LIST+=" $!"
