...
kli multisig incept --name delegator2 --alias delegator2 --group delegator --version 1.0 --file ${KERI_DEMO_SCRIPT_DIR}/data/multisig-delegator.json &
pid=$!
PID_LIST+=" $pid"
...
kli multisig incept --name delegate2 --alias delegate2 --group delegate --version 1.0 --file ${KERI_DEMO_SCRIPT_DIR}/data/multisig-delegate.json &
pid=$!
PID_LIST+=" $pid"
