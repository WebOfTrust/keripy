...
kli multisig rotate --name multisig1 --alias multisig --smids EKYLUMmNPZeEs77Zvclf0bSN5IN-mLfLpx2ySb-HDlk4:1 --smids EJccSRTfXYF6wrUVuenAIHzwcx3hJugeiJsEKmndi5q1:1 --smids ENkjt7khEI5edCMw5qugagbJw1QvGnQEtcewxb0FnU9U:0 --isith '["1/2", "1/2", "1/2"]' --nsith '["1/2", "1/2"]' --rmids EKYLUMmNPZeEs77Zvclf0bSN5IN-mLfLpx2ySb-HDlk4 --rmids ENkjt7khEI5edCMw5qugagbJw1QvGnQEtcewxb0FnU9U
exit 0
pid=$!
PID_LIST+=" $pid"
