...
curl -s -X POST "http://localhost:5623/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"Bob\", \"url\":\"http://127.0.0.1:5643/oobi/EHvJernk0fXfDpWRt93NeuTzZUOrvfnPaH7__63PJdqw/witness/BLskRTInXnMxWaGqcpSyMgo0nYbalW99cGZESrz3zapM\"}" | jq
curl -s -X POST "http://localhost:5723/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"Alice\", \"url\":\"http://127.0.0.1:5644/oobi/ERFmtKcQCd8xW7Rzl-PqyJ1QAfJYlfdMxYRVncPBMDkk/witness/BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX\"}" | jq
