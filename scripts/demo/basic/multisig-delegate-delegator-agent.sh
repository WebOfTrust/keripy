...
sleep 3
curl -s -X POST "http://localhost:5623/oobi/delegate1" -H "accept: */*" -H "Content-Type: application/json"  -d "{\"oobialias\": \"delegate2\", \"url\":\"http://127.0.0.1:5642/oobi/E64X4wS9Oaps6NtcsE_rgNoxxAT5QzdGfGyUKu1ecHgo/witness/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\"}" | jq
curl -s -X POST "http://localhost:5723/oobi/delegate2" -H "accept: */*" -H "Content-Type: application/json"  -d "{\"oobialias\": \"delegate1\", \"url\":\"http://127.0.0.1:5642/oobi/Eo6MekLECO_ZprzHwfi7wG2ubOt2DWKZQcMZvTbenBNU/witness/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\"}" | jq
curl -s -X POST "http://localhost:5823/oobi/delegator1" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"delegator2\", \"url\":\"http://127.0.0.1:5642/oobi/EC1DxuYp8GgIDVQ2c8EYBaY1CwxozvQuqGxwppNVrapY/witness/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\"}" | jq
curl -s -X POST "http://localhost:5923/oobi/delegator2" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"delegator1\", \"url\":\"http://127.0.0.1:5642/oobi/Ef9Bhn_LeAU3rq8Rf3XHi5C1XmNdIM5uxv2DwWQT6qd8/witness/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\"}" | jq
sleep 3
curl -s -X POST "http://localhost:5823/groups/delegator/icp" -H "accept: */*" -H "Content-Type: application/json" -d "{\"aids\":[\"Ef9Bhn_LeAU3rq8Rf3XHi5C1XmNdIM5uxv2DwWQT6qd8\",\"EC1DxuYp8GgIDVQ2c8EYBaY1CwxozvQuqGxwppNVrapY\"], \"transferable\":true,\"wits\":[\"BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\", \"BLskRTInXnMxWaGqcpSyMgo0nYbalW99cGZESrz3zapM\",\"BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX\"],\"toad\":3, \"isith\":2,\"nsith\":2}" | jq
curl -s -X PUT "http://localhost:5923/groups/delegator/icp" -H "accept: */*" -H "Content-Type: application/json" -d "{\"aids\":[\"Ef9Bhn_LeAU3rq8Rf3XHi5C1XmNdIM5uxv2DwWQT6qd8\",\"EC1DxuYp8GgIDVQ2c8EYBaY1CwxozvQuqGxwppNVrapY\"], \"transferable\":true,\"wits\":[\"BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\", \"BLskRTInXnMxWaGqcpSyMgo0nYbalW99cGZESrz3zapM\",\"BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX\"],\"toad\":3, \"isith\":2,\"nsith\":2}" | jq

sleep 2
curl -s -X POST "http://localhost:5623/oobi/delegate1" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"delegator\", \"url\":\"http://127.0.0.1:5642/oobi/EZbh5QuW1HI4dmYZrKYIjXE_34E5c2np8HjKggen7bu8/witness/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\"}"
curl -s -X POST "http://localhost:5723/oobi/delegate2" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"delegator\", \"url\":\"http://127.0.0.1:5642/oobi/EZbh5QuW1HI4dmYZrKYIjXE_34E5c2np8HjKggen7bu8/witness/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\"}"

sleep 2
curl -s -X POST "http://localhost:5623/groups/delegate/icp" -H "accept: */*" -H "Content-Type: application/json" -d "{\"delpre\":\"EZbh5QuW1HI4dmYZrKYIjXE_34E5c2np8HjKggen7bu8\", \"aids\":[\"Eo6MekLECO_ZprzHwfi7wG2ubOt2DWKZQcMZvTbenBNU\",\"E64X4wS9Oaps6NtcsE_rgNoxxAT5QzdGfGyUKu1ecHgo\"], \"transferable\":true,\"wits\":[\"BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha\", \"BLskRTInXnMxWaGqcpSyMgo0nYbalW99cGZESrz3zapM\",\"BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX\"],\"toad\":3, \"isith\":2,\"nsith\":2}" | jq
