...
kli rotate --name witness-test --alias trans-wits --witness-cut BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX
isSuccess

kli status --name witness-test --alias trans-wits

kli rotate --name witness-test --alias trans-wits --witness-add BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX
isSuccess
