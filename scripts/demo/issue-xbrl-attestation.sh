...
# kli vc issue --name person --alias person --registry-name vLEI-person --schema Ehwr6tZh6XakKBKWQW07otQ9uCwg0g7CF-dPz9qb_fwQ --data @scripts/demo/xbrl-data.json --edges @/tmp/xbrl-edges.json
