...
curl -s -X POST "http://localhost:5623/oobi/multisig2" -H "accept: */*" -H "Content-Type: application/json" -d "{\"url\":\"http://127.0.0.1:5642/oobi/ED5IijFSuXv9ieknCduE_GXyX0h0o30bhtoemUO_wPwI/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
curl -s -X POST "http://localhost:5723/oobi/multisig1" -H "accept: */*" -H "Content-Type: application/json" -d "{\"url\":\"http://127.0.0.1:5642/oobi/ED5IijFSuXv9ieknCduE_GXyX0h0o30bhtoemUO_wPwI/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
sleep 2
