...
.PHONY: build-keri
build-keri:
	@docker buildx build --platform=linux/amd64 -f images/keripy.dockerfile --tag weboftrust/keri:1.2.0-dev10 .
	@docker buildx build --platform=linux/arm64 -f images/keripy.dockerfile --tag weboftrust/keri:1.2.0-dev10-arm64 .
...
.PHONY: publish-keri
publish-keri:
	@docker push weboftrust/keri:1.2.0-dev10
	@docker push weboftrust/keri:1.2.0-dev10-arm64
